...
class SelectInfoFromDB(forms.Form):
    ...
    data_from = forms.DateField(widget=DateInput(attrs={'class': 'form-control datepicker',
                                                        'placeholder': "Data from: yyyy-mm-dd ",
                                                        'type': "text",
                                                        'id': "data_from"
                                                                  }))
    data_to = forms.DateField(widget=DateInput(attrs={'class': 'form-control datepicker',
